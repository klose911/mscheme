...
public class AddFuncTest {
    @Test
    public void addDouble() throws WrongArgumentNumberException, WrongArgumentTypeException {
    ...
    @Test
    public void addFloat() throws WrongArgumentNumberException, WrongArgumentTypeException {
    ...
    @Test
    public void addLong() throws WrongArgumentNumberException, WrongArgumentTypeException {
    ...
    @Test
    public void addInteger() throws WrongArgumentNumberException, WrongArgumentTypeException {
